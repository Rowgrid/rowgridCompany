    ...
    <div className="overflow-hidden">
      <div className="">
        <div class="relative">
          <img
            ...
            alt=""
          />
          <div class="relative pb-12 bg-primary bg-opacity-90">
            {/* <!-- Uncomment if needed -->
      <!--
      ...
      --> */}
            <div class="relative mx-auto overflow-hidden px-4 py-8 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-2">
              ...
              initial="hidden"
              animate="visible"
              class="mb-6 max-w-lg font-sans text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white"
            >
              Your <span className="text-[#eab308]">Vision</span>, Our Expertise
            </motion.h2> */}
                  <motion.h2
                    variants={container(0)}
                    initial="hidden"
                    animate="visible"
                    class="mb-6 max-w-lg font-sans text-6xl sm:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white"
                  >
                    <span class="block lg:inline">Your</span>{" "}
                    <span class="block lg:inline text-[#eab308]">
                      Vision<span className="text-white">,</span>
                    </span>{" "}
                    <span class="block lg:inline">Our</span>{" "}
                    <span class="block lg:inline">Expertise</span>
                  </motion.h2>
                  <motion.p
                    variants={container(0.5)}
                    initial="hidden"
                    animate="visible"
                    class="mb-4 max-w-xl text-lg sm:text-xl md:text-md text-gray-400 pb-4"
                  >
                  ...
                  <motion.a
                    ...
                    href="/"
                    aria-label=""
                    class="btn p-3 mt-7 no-underline rounded-md text-white bg-[#eab308] hover:bg-white hover:text-[#eab308]"
                  >
                    Start Your Journey
                  </motion.a>
                </div>
                <div class="w-full max-w-xl xl:w-5/12 px-2 xl:px-8 pt-10">
                  <div class="rounded-xl flex justify-center border-t-4 border-emerald-600 bg-white p-7 sm:p-10">
                    <img
                      className="sm:w-[500px] sm:h-[300px] w-96 h-96 rounded opacity-60 object-contain"
                      src={bg1}
                      alt=""
                    />
                  </div>
